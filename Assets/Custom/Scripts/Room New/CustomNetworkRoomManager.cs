...
public class CustomNetworkRoomManager : NetworkRoomManager
{
    ...
    public static new CustomNetworkRoomManager singleton => (CustomNetworkRoomManager)NetworkRoomManager.singleton;
    public float searchTimeout = 5f; // Tiempo máximo para buscar servidores

    public override Transform GetStartPosition()
    {
        // Obtiene un punto de spawn aleatorio de la lista de NetworkStartPosition
    ...
    */
    ...
    public void AutoStart() {
        StartCoroutine(SearchAndStart());
    }

    IEnumerator SearchAndStart()
    {
        // Iniciar búsqueda de servidores
        StartClient(); // Intenta conectarse automáticamente al servidor (si hay uno)
        yield return new WaitForSeconds(searchTimeout);

        // Si no se conectó, iniciar como host
